        ...
        for (let i = 20; i <= 30; i++) {
            ...
            cells.push(
                <div
                    ...
                    className={cn(
                        'tile-cell',
                        isCorner ? 'corner-tile' : 'horizontal-tile',
                    )}
                    onClick={() => {
                ...
                >
                    <div className="color-strip" style={{backgroundColor: tileStyle.color}}></div>
    ...
    const renderBottomRow = () => {
        ...
        for (let i = 10; i >= 0; i--) {
            ...
            cells.push(
                ...
                >
                    <div className="color-strip bottom" style={{backgroundColor: tileStyle.color}}></div>
                    {renderTileLabel(tile)}
                </div>
            );
        }
    ...
    const renderLeftColumn = () => {
        ...
        for (let i = 19; i >= 11; i--) {
            ...
            cells.push(
                <div
                    key={`left-${i}`}
                    className="tile-cell vertical-tile"
                    onClick={() => {
                        setSelectedTile(tile);
                        setDialogOpen(true);
                    }}
                >
                    <div className="color-strip left" style={{backgroundColor: tileStyle.color}}></div>
                    {renderTileLabel(tile)}
                </div>
            );
        }
    ...
    const renderRightColumn = () => {
        ...
        for (let i = 31; i <= 39; i++) {
            ...
            cells.push(
                ...
                >
                    <div className="color-strip right" style={{backgroundColor: tileStyle.color}}></div>
                    {renderTileLabel(tile)}
                </div>
            );
        }
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div className="font-medium">{formatCurrency(property.rent_0_house)}</div>

                                <div>1 House:</div>
                                <div className="font-medium">{formatCurrency(property.rent_1_house)}</div>

                                <div>2 Houses:</div>
                                <div className="font-medium">{formatCurrency(property.rent_2_house)}</div>

                                <div>3 Houses:</div>
                                <div className="font-medium">{formatCurrency(property.rent_3_house)}</div>

                                <div>4 Houses:</div>
                                <div className="font-medium">{formatCurrency(property.rent_4_house)}</div>

                                <div>Hotel:</div>
                                <div className="font-medium">{formatCurrency(property.rent_hotel)}</div>
                            </div>
                        </div>
                    </div>
                );
                ...
                details = (
                    <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div className="font-medium capitalize">{special.type}</div>
                        </div>
                    </div>
                );
                break;
                    ...
                    <DialogHeader>
                        <DialogTitle>
                            {selectedTile?.property?.name ||
                                ...
                                (selectedTile?.special?.type && `${selectedTile.special.type.charAt(0).toUpperCase() + selectedTile.special.type.slice(1)}`) ||
                                'Tile Details'}
                        </DialogTitle>
                        <DialogDescription>
