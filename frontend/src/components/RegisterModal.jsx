...
export const RegisterModal = ({onClose, onSwitchView}) => {
            ...
            <DialogContent className="sm:max-w-md">
                ...
                {error && (
                    <Alert variant="destructive" className="mt-4">
                        ...
                        {error.includes("already exists") && (
                            <Button
                                variant="link"
                                className="mt-2 p-0 h-auto font-medium text-destructive hover:text-destructive/90"
                ...
                {success ? (
                    <div className="py-6 text-center space-y-4">
                        <div
                            className="mx-auto bg-green-100 rounded-full p-3 w-16 h-16 flex items-center justify-center">
